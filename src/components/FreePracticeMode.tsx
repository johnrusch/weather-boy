...
import { useLanguageSession, DEFAULT_SETTINGS } from '../hooks/useLanguageSession';
...
export function FreePracticeMode({ onExit }: FreePracticeModeProps) {
    ...
    <div className="bg-white rounded-lg shadow-md p-6 max-w-md mx-auto">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          onChange={(e) => setSettings({
            ...settings,
            promptCount: Math.min(10, Math.max(1, parseInt(e.target.value, 10) || 1))
          })}
      ...
      <div className="mb-6">
        ...
        <input
          ...
          onChange={(e) => setSettings({
            ...settings,
            promptDuration: Math.min(10, Math.max(1, parseInt(e.target.value, 10) || 1))
          })}
          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        />
      </div>
  ...
  const renderStartSession = () => (
    <div className="flex flex-col items-center justify-center py-8">
      ...
      <div className="text-gray-600 mb-8 text-center max-w-md">
        Practice your speaking skills with random prompts. 
        Your responses will be evaluated and you'll receive personalized feedback.
      </div>
  ...
  const renderSessionInProgress = () => (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Active prompt */}
      {currentPromptIndex >= 0 && currentPromptIndex < selectedPrompts.length && (
        <PromptDisplay
