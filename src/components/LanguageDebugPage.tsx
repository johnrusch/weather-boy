...
import { resetLanguageSettings } from "../scripts/resetLanguage";

export function LanguageDebugPage() {
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        ...
        <p className="text-sm text-gray-500 mt-2">
          Note: Each action will reload the page to ensure all components update
          properly.
        </p>
      </div>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-700">
          <li>
            The language context is managed in{" "}
            <code className="text-pink-600 bg-gray-100 px-1 py-0.5 rounded">
              src/contexts/LanguageContext.tsx
            </code>
          </li>
          <li>
            The HeaderLanguageSelector component is in{" "}
            <code className="text-pink-600 bg-gray-100 px-1 py-0.5 rounded">
              src/components/HeaderLanguageSelector.tsx
            </code>
          </li>
          <li>
            Language settings are stored in localStorage under the key{" "}
            <code className="text-pink-600 bg-gray-100 px-1 py-0.5 rounded">
              preferredLanguage
            </code>
          </li>
          <li>
            When language changes, the app should dispatch a{" "}
            <code className="text-pink-600 bg-gray-100 px-1 py-0.5 rounded">
              languageChanged
            </code>{" "}
            event
          ...
          <li>
            The main app is in{" "}
            <code className="text-pink-600 bg-gray-100 px-1 py-0.5 rounded">
              src/components/LanguageLearningApp.tsx
            </code>
          </li>
        </ul>
      </div>
