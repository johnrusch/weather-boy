  ...
  return (
    <div className="flex flex-col items-center justify-center py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 mb-4">
            Progress through a series of levels with increasingly difficult challenges.
            Track your improvements and unlock new content as you advance.
          </p>
      ...
      <div className="mt-12 text-center text-gray-500 text-sm">
        ...
        <p>You can change languages at any time using the selector in the header.</p>
      </div>
    </div>
  );
}
