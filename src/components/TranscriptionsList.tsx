...
export const TranscriptionsList: React.FC<TranscriptionsListProps> = ({ transcriptions }) => {
  const downloadTranscription = (transcription: Transcription, index: number) => {
    ...
    const language = transcription.prompt.language ? 
      transcription.prompt.language.charAt(0).toUpperCase() + transcription.prompt.language.slice(1) : 
      'Target Language';
          ...
          >
            ...
            {transcription.evaluation && (
              <div className="mt-2 p-3 bg-gray-100 rounded-lg">
                <h4 className="font-medium text-gray-700 mb-2">Response Evaluation</h4>
                <div className="text-sm text-gray-600 space-y-1">
                  <p>Score: {transcription.evaluation.score}/10</p>
                  <p>{language} Usage: {transcription.evaluation.percentageTargetLanguage}%</p>
                  <p>Prompt Relevance: {transcription.evaluation.promptRelevance}</p>
