...
export const initialCampaignLevels: CampaignLevel[] = [
  {
    ...
    description: "Learn essential phrases for introducing yourself and greeting others.",
    prompts: [
      {
...
export const getCampaignLevelForLanguage = (levels: CampaignLevel[], targetLanguage: string): CampaignLevel[] => {
  ...
  return levels.map(level => ({
    ...level,
    description: level.description.replace(/French|Spanish/gi, targetLanguage.charAt(0).toUpperCase() + targetLanguage.slice(1)),
